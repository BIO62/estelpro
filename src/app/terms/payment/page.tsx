    ...
    <>
      <div className="d-lg-none border-bottom bg-white">
            <div className="container">
                ...
                <Link href="/terms/payment" className="btn btn-sm fs-13 fw-semibold fc-main py-2 text-start">Төлбөрийн нөхцөл</Link>
              </nav>
            </div>
          </div>
                ...
                <div className="col-lg-3 d-none d-lg-block">
                  <div className="sticky-top" style={{top:"88px"}}>
                    <nav className="d-flex flex-column">
                      ...
                      <Link href="/terms/payment" className="side-nav-item active">Төлбөрийн нөхцөл</Link>
                    </nav>
                  </div>
                </div>
