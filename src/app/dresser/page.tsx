    ...
    <>
      <style
        dangerouslySetInnerHTML={{
          __html: `
          .dresser-hero { position:relative; overflow:hidden; min-height:520px; display:flex; align-items:center; }
          ...
          .cat-overlay { position:absolute; inset:0; background:linear-gradient(to top,rgba(0,0,0,.75) 0%,rgba(0,0,0,.15) 55%,transparent 100%); }
          .cat-label { position:absolute; bottom:0; left:0; right:0; padding:24px 20px; }
        ...
        <div className="container py-5 dresser-hero-content w-100">
          <div className="row py-3">
            <div className="col-lg-7 col-xl-6">
              <span className="dresser-section-label d-block mb-3" style={{ color: 'rgba(255,255,255,.65)' }}>
                Салоны мэргэжлийн портал
              </span>
              <h1 className="fw-bold fc-white lh-sm mb-3" style={{ fontSize: 'clamp(28px,4vw,52px)' }}>
                ESTEL Professional<br />
                <span style={{ color: '#FFC20F' }}>Мэргэжлийн каталог</span>
              </h1>
              <p className="mb-4 fs-15" style={{ color: 'rgba(255,255,255,.72)' }}>
                Дэлхийн тэргүүлэгч ESTEL брэндийн бүтээгдэхүүнийг мэргэжлийн үнэ, гэрээт хөнгөлөлттэйгөөр салондоо захиалан аваарай.
              </p>
              <div className="d-flex gap-3 flex-wrap mb-5">
                <Link href="/dresser/list" className="btn btn-main px-4 py-3 fw-semibold rounded-3 text-decoration-none">
              ...
              <div className="d-flex gap-4 align-items-center">
                ...
                <div className="hero-stat-line"></div>
                <div>
                  <strong className="fc-white d-block" style={{ fontSize: '26px', letterSpacing: '-.02em' }}>1,400+</strong>
                  <span className="fs-12" style={{ color: 'rgba(255,255,255,.55)' }}>Гэрээт салон ба үсчид</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* 2. ОНЦЛОХ АНГИЛАЛ (1:1 from index-dresser.html) */}
      <section className="py-5" id="categories">
        <div className="container">
          <div className="d-flex align-items-end justify-content-between mb-4">
            ...
            <Link href="/dresser/list" className="btn btn-outline-dark btn-sm rounded-pill px-3">
              Бүгдийг харах →
            </Link>
          </div>
          ...
          <div className="row g-3 mb-3">
            <div className="col-lg-8">
              <Link href="/dresser/list" className="d-block cat-card rounded-4" style={{ height: '340px' }}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={assetUrl('images/taxon/үсний будаг.jpg')} alt="De Luxe" />
                <div className="cat-overlay"></div>
                <div className="cat-label">
                  <span className="dresser-section-label d-block mb-1" style={{ color: 'rgba(255,255,255,.65)' }}>
                    Хамгийн эрэлттэй
                  </span>
                  <h3 className="fw-bold fc-white mb-1" style={{ fontSize: '28px' }}>
                    De Luxe
                  </h3>
                  <p className="mb-0 fs-13" style={{ color: 'rgba(255,255,255,.72)' }}>
                    Урт эдэлгээт мэргэжлийн өнгийн будаг
                  </p>
                </div>
              </Link>
            </div>
            <div className="col-lg-4">
              <Link href="/dresser/list" className="d-block cat-card rounded-4" style={{ height: '340px' }}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={assetUrl('images/taxon/хүүхдийн арчилгаа.jpg')} alt="Haute Couture" />
                <div className="cat-overlay"></div>
                <div className="cat-label">
                  <span className="dresser-section-label d-block mb-1" style={{ color: 'rgba(255,255,255,.65)' }}>
                    Тансаг чанар
          ...
          <div className="row g-3 mb-3">
            <div className="col-4">
              <Link href="/dresser/list" className="d-block cat-card rounded-4" style={{ height: '210px' }}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={assetUrl('images/taxon/үс арчилгаа.jpg')} alt="Sensation" />
                <div className="cat-overlay"></div>
                <div className="cat-label">
                  <h5 className="fw-bold fc-white mb-1">Sensation</h5>
                  <p className="mb-0 fs-12" style={{ color: 'rgba(255,255,255,.7)' }}>
                    Аммиакгүй будаг
                  </p>
                </div>
              </Link>
            ...
            <div className="col-4">
              <Link href="/dresser/list" className="d-block cat-card rounded-4" style={{ height: '210px' }}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={assetUrl('images/taxon/Alpha.jpg')} alt="Curex" />
                <div className="cat-overlay"></div>
                <div className="cat-label">
            ...
            <div className="col-4">
              <Link href="/dresser/list" className="d-block cat-card rounded-4" style={{ height: '210px' }}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={assetUrl('images/taxon/хэлбэржүүлэлт.jpg')} alt="Alpha Homme" />
                <div className="cat-overlay"></div>
                <div className="cat-label">
      ...
      <section className="py-5" style={{ background: '#F2F2F2' }} id="lines">
        <div className="container">
          ...
          <div className="mb-4">
            <div className="d-flex align-items-center justify-content-between mb-3 pb-2" style={{ borderBottom: '1.5px solid #E0E8EF' }}>
              <strong className="fs-14 fc-dark">Curex цуврал</strong>
              <Link href="/dresser/list" className="fs-12 text-muted text-decoration-none">Бүгдийг харах →</Link>
            </div>
            <div className="row row-cols-4 row-cols-sm-5 row-cols-md-7 row-cols-lg-9 g-2">
