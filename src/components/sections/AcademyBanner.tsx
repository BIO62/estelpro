    ...
    <section>
      <div className="container-fluid p-0 position-relative">
        <div className="d-sm-block d-none">
          ...
          <img src={assetUrl('images/demo/bottomDesktopImage.webp')} alt="" className="w-100 h-auto img-cover" />
        ...
        <div className="d-sm-none d-block position-relative">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={assetUrl('images/demo/bottomDesktopImage.webp')} alt="" className="w-100 h-320 img-cover" />
